...
(function() {
  ...
  // var DEFAULT_MANIFEST = "http://localhost:8080/cHVibGljYXRpb24vY2Mtc2hhcmVkLWN1bHR1cmUuZXB1Yg==/manifest.json";
  //
  var DEFAULT_MANIFEST = "http://localhost/epubs/cc-shared-culture.epub/manifest";
  
  // var DEFAULT_MANIFEST = "http://localhost/epubs/moby-dick.epub/manifest";
  // var DEFAULT_MANIFEST = "http://localhost/epubs/elps.epub/manifest";
 // var DEFAULT_MANIFEST = "";// "http://localhost/epubs/movie.epub/manifest";
  ...
  initializeNavigation(manifest_url, document_url).catch(function() {
    console.log("error? in initialize Navigation... ");
  });
  ...
  function initializeNavigation(url, document_url) {
    return getManifest(url).then(function(json) { 
      ...
      if (json.resources) { 
        console.log("exist json.resource");
        var all_resources = json.spine.concat(json.resources); 
      }
      else { 
        console.log("using json.spine");
